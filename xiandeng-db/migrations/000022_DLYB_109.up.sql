...
begin
 ...
 loop 
  ...
  loop 
   ...
   on conflict(studentid,entitlementtypeid) do update set lastorderid=order_id,expiresat = case WHEN studententitlement.expiresat < CURRENT_DATE THEN CURRENT_DATE + var_entitlement.validdays ELSE studententitlement.expiresat + var_entitlement.validdays END;
