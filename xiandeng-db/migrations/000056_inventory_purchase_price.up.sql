...
BEGIN
	...
	NEW.unitprice := (v_product.pricingschedule->>concat(v_account.type,'-course-purchase-price'))::numeric(8,2) - (v_product.pricingschedule->>'conversion-award')::numeric(8,2);-- 获取进货价
