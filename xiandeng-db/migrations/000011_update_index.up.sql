CREATE UNIQUE INDEX idx_unique_balanceactivity_accountid_orderid_source ON public.balanceactivity USING btree (accountid, orderid,source);

DROP INDEX public.idx_unique_balanceactivity_accountid_orderid;
